	...
	if(isset($_POST["submit"]))
	{
		...
		$dir="C:/XAMPP/htdocs/University_Voting/images/Upload/";
		...
		$Type='v';
		$Voted='No';
		if(move_uploaded_file($_FILES['img']['tmp_name'],"C:/XAMPP/htdocs/University_Voting/images/Upload/".$newfilename.'.jpg'))
		{
...
<head>
  ...
  <link rel="stylesheet" href="file:///E|/CSS/register.css" type="text/css" />
 ...
 programLists["CMPICA"] =["MCA","BCA", "BSCIT","MSCIT"];  
 programLists["PDPIS"] =["BSC","MSC", "M.Phil","Ph.D"]; 
 programLists["RPCP"] =["B.Pharm","M. Pharm","PGDCT"];  
 programLists["ARIP"]=["B.COM","M.COM"]; 
...
<div class="row">
    ...
    <div class="pom-agile col-md-8">
      	<select class="form-control" name="Department" id="institute" onchange="programChange(this);" required>
				<option value="empty">select Department</option>
				<option value="CMPICA">Computer Application</option>
				<option value="PDPIS">Science</option>
				<option value="RPCP">Medical Science</option>
				<option value="ARIP">Commerce</option>
		</select>
    </div>
  </div>
...
<div class="row">
	...
	<div class="pom-agile col-md-8">
	  <span class="fa fa-user-o" aria-hidden="true"></span>
      	<input class="form-control" title="Enter valid phone Number." type="text" id="phone" name="phone"  pattern="[789][0-9]{9}" placeholder="Enter Your Phone Number." required onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');">
...
<div class="row">
  ...
  this.setCustomValidity(this.validity.patternMismatch ? this.title : '');">
	...
	<div class="footer col-sm-12">
		<p>&copy; All rights reserved | Design by MIHIR AND ADITYA</p>
	</div>
	<!--//footer-->
	<!---728x90--->
</body>
